...
| [`@backendkit-labs/firewall`](./packages/firewall) | 0.1.2 | Web Application Firewall — SQLi, XSS, Path Traversal, Command Injection, NoSQL Injection, SSRF detection + NestJS integration |
