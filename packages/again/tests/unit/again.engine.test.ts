...
import { AgainEngine } from '../../src/again/again.engine.js';

function makeEngine(overrides?: ConstructorParameters<typeof AgainEngine>[0]): AgainEngine {
  return new AgainEngine({ name: 'test', ...overrides });
}

describe('AgainEngine', () => {
